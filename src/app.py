...
def get_brazilian_death_cases():
    return pd.read_csv('brazilian covid-19 data/brazilian_deaths_series.csv')
@st.cache
def get_brazilian_recovered_cases():
    return pd.read_csv('brazilian covid-19 data/brazilian_recovered_series.csv')
@st.cache
def get_brazilian_active_cases():
    return pd.read_csv('brazilian covid-19 data/brazilian_active_series.csv')
